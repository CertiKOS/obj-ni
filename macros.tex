...
\newcommand{\ob}[3]{\ensuremath{\obsymbol_{#2}(#1)}}
\newcommand{\treq}[4]{#1 \approx^{#4}_{#3} #2}
\newcommand{\classpart}{\ensuremath{\mathcal{M}}}
\newcommand{\emptytr}{\ensuremath{\epsilon}}
\newcommand{\obsim}{\ensuremath{\approx}\xspace}
